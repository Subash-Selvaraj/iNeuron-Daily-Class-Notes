...
##print(test(2,3)) --we have to call this in post man


# create falsk object to access the post man
app = Flask(__name__)
...
@app.route('/abc2/subraction',methods=['GET','POST'])
def test4():
    if(request.method=='POST'):
        a = request.json['num1']
        b = request.json['num2']
...
@app.route('/abc2/square',methods=['GET','POST'])
def test5():
    if(request.method=='POST'):
        a = request.json['num1']
        b = request.json['num2']
